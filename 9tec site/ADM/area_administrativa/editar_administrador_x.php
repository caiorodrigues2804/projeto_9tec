...
<?php 
            ...
            if (isset($_GET["senha"])) {
                ...
                if ($verificador <= 0) 
                {
                  ...
                  $cmd->execute();
                    ...
                    $url =  '<meta http-equiv="refresh" content="5; url=editar_administrador_x.php?id_adm=' . $_GET["id_adm"] . '&edit=' . $_GET["edit"] . '">';
                    echo $url;
                    ...
                    mensagem_atencao("Sua senha foi alterada com sucesso","success");
                    $url =  '<meta http-equiv="refresh" content="5; url=editar_administrador_x.php?id_adm=' . $_GET["id_adm"] . '&edit=' . $_GET["edit"] . '&pagina=' . $_GET["pagina"] . '">';
                    echo $url;    
            ...
            if(isset($_GET["dados"]))
            {
                if (isset($_POST)) {
                       ...
                       $cmd = $pdo->prepare("SELECT COUNT(*) count FROM `administracao` WHERE `adm_nome` = :adm_nome_d AND `adm_id` <> :adm_id_s_03;");
                        ...
                        $cmd->bindValue(":adm_id_s_03",addslashes($_GET["id_adm"]), PDO::PARAM_STR);
                        $cmd->execute();
                        $existe_ou_nao=0;
                        ...
                        mensagem_atencao("Já existe alguém com esses e-mail, nome cadastrados","danger");
                        $url =  '<meta http-equiv="refresh" content="5; url=editar_administrador_x.php?id_adm=' . $_GET["id_adm"] . '&edit=' . $_GET["edit"] . '">';
                        echo $url;
                        ...
                        } else if($existe_ou_nao <= 0)
                        {
                            ...
                            $cmd->bindValue(":adm_nome_d",addslashes($_POST["nome"]), PDO::PARAM_STR);
                            $cmd->bindValue(":adm_email_d",addslashes($_POST["email"]), PDO::PARAM_STR);
                            $cmd->bindValue(":adm_id_s_03",$_GET["id_adm"], PDO::PARAM_STR);
                            $cmd->execute();
            ...
            $cmd = $pdo->prepare("SELECT * FROM `administracao` WHERE `adm_id` = '$_GET[id_adm]';");
            $cmd->execute(); 
              ...
              <center>
                ...
                <hr>
                 ...
                 <div class="form-group">
                        ...
                        <div class="mt-4"></div>
                        <!-- ============================================================== -->
                        <form action="editar_administrador_x.php?dados=1&id_adm=<?php print $_GET['id_adm'];?>&edit=<?php print $_GET['edit']; ?><?php 
                            if(isset($_GET["pagina"])):
                                print '&pagina=' . $_GET["pagina"];
                            endif;
                        ?>" method="post">
                        ...
                        <h5>Alterar senha</h5>
                        <br>
                        <form action="editar_administrador_x.php?senha=1&id_adm=<?php print $_GET['id_adm'];?>&edit=<?php print $_GET['edit']; ?><?php if(isset($_GET['pagina']) && !empty($_GET['pagina'])){
                            print '&pagina=' . $_GET["pagina"];
                        }?>" method="post">
